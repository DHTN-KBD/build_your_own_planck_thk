...
このドキュメントでは、Planck Through Hole Kitの製作およびファームウェアの変更手順などについて解説します。
...
まず、トッププレートとなる基板に10個のスペーサーをネジ止めします。基板の下にスペーサーがくるようにして、基盤の上からネジで止めていきます。

次に、ボトムプレートとなる基板を10個のスペーサーに対してネジ止めします。

構造としては以下のようにスペーサーを上下の基板で挟む形です。
